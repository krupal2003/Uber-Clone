...
const ConfirmRide = (props) => {
    return (
        <div>
            <h5 onClick={() => { props.setConfirmRideOpen(false) }} className='absolute top-1 w-[90%] text-center'><i className='ri-arrow-down-wide-fill w-8 text-3xl text-gray-400'></i></h5>
